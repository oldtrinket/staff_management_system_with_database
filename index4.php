...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="d-flex justify-content-between my-3">
            <a class="btn btn-primary" href="/henry_ff/index2.php" role="button">Home</a>
        </div>
        <br>
        <table class="table">
            <thead>
            ...
            <tbody>
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>$row[roleID]</td>
                        <td>
                            <a class='btn btn-primary btn-sm' href='/henry_ff/edit_limited.php?staffID=$row[staffID]' role='button'>Edit/Update</a>
                            <a class='btn btn-primary btn-sm' href='/henry_ff/availability_limited.php?staffID=$row[staffID]' role='button'>Availability</a>
                        </td>
                    </tr>
                    ";
